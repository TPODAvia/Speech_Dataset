...
with open('D:\\Datasets\\ruls_data\\test\\manifest.json', 'r', encoding='utf-8') as json_file:
...
with open('ruls_extr.txt', 'w', encoding='utf-8') as output_file:
    for index, row in extracted_data.iterrows():
        output_file.write(f"ruls_data/train/{row['audio_filepath']}|{phonemize(global_phonemizer, row['text_no_preprocessing'])}|{row['constant']}\n")